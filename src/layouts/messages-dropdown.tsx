...
import { Popover, Avatar, Badge, Whisper } from "rsuite";
            ...
            >
              ...
              <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center">
                <div className="w-full">
                  <h6 className="mb-0.5 text-sm font-semibold">
                    {item.name}
                  </h6>
                  <div className="flex">
                    <span className="w-10/12 truncate pe-7 text-xs text-gray-500">
                      {item.message}
                    </span>
...
export default function MessagesDropdown({
  ...
  const speaker = (
    <Popover className="z-[9999] pb-6 pe-6 ps-0 pt-5 dark:bg-gray-100">
